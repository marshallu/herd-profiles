...
if ( 2 === intval( get_field( 'department_per_row', $the_term ) ) ) {
	$grid = 'mup:lg:grid-cols-2';
} elseif ( 3 === intval( get_field( 'department_per_row', $the_term ) ) ) {
	$grid = 'mup:lg:grid-cols-3';
} else {
	$grid = 'mup:lg:grid-cols-4';
}
?>
<div class="mup:grid mup:grid-cols-1 mup:md:grid-cols-2 <?php echo esc_attr( $grid ); ?> mup:gap-8">
<?php
while ( have_posts() ) {
	the_post();
